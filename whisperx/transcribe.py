...
def cli():
    ...
    parser.add_argument("--detect_language_per_segment", action="store_true", help="Use this for multi language audio, if you want language detection to happen for every segment. ")
